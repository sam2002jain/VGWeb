  ...
  return (
    <header className={styles.header}>
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between relative">
        ...
        {/* Mobile side drawer */}
        <div className={`fixed top-0 right-0 h-full w-80 bg-gradient-to-b from-amber-900 to-amber-800 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} md:hidden overflow-y-auto`}>
          <div className="p-6">
            {/* Close button */}
